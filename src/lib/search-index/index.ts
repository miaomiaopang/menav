...
import type { SearchIndexItem, SearchIndexPayload } from '../../types/search';
...
function createSearchIndexItem(card: CardViewModel): SearchIndexItem {
  return {
    ...
    ...(card.categoryPath && card.categoryPath.length > 0
...
export { MENAV_SEARCH_INDEX_FILE, SEARCH_INDEX_SCHEMA_VERSION, buildSearchIndex };
